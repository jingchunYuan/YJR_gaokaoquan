...
@interface ZhiyuanViewController ()

@property (nonatomic,strong) UIButton *btn;

@property (nonatomic,strong) UIButton *btn2;

@property (nonatomic,strong) ZhiyuanTableView *tableview;
...
@implementation ZhiyuanViewController
...
- (void)setUI
{
    ...
    self.navigationItem.titleView = [self.view titleWithNavigat:@"志愿定制报告"];
    ...
    [[JYNetWorkTool sharedTools]request:JYRequestMethodGET urlString:@"http://api.dev.gaokaoq.com/service/view?id=6" parameters:nil callback:^(id responseObject, NSError *error) {
        
        ZhiyuanModel *same = [ZhiyuanModel mj_objectWithKeyValues:responseObject[@"data"]];
    ...
    [Buy setTitle:@"立即购买(118.00元/2次)" forState:UIControlStateNormal];
    ...
    ZhiyuanTableView *tableview = [[ZhiyuanTableView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(button2.frame), KWIDTH, 400)];

...
@interface LuquShowView () <UITableViewDelegate,UITableViewDataSource>
...
- (UITableView *)myTabelView{
    ...
    [_myTabelView registerNib:[UINib nibWithNibName:@"LuquTableViewCell" bundle:nil] forCellReuseIdentifier:@"LuquTableViewCell"];
    return _myTabelView;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    LuquTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SQMenuShowCell"];
...
-(void)setSelectBlock:(void (^)(LuquShowView *, NSInteger))block
{
